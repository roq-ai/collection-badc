  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Collection - Your comprehensive hub for seamless carsharing, profile management, reservations, and insightful vehicle usage tracking. Drive towards efficiency with us."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Collection - Your comprehensive hub for seamless carsharing, profile management, reservations, and insightful vehicle usage tracking. Drive towards efficiency with us.`}
            </Text>
            <Box
